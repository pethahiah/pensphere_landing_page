...
const CallToAction = () => {
    ...
    return (
        <div className="min-h-[50vh] px-[6%] h-fit flex flex-row justify-center items-center my-28">
            <div className='w-full bg-[#0898A0]  flex flex-row flex-wrap justify-between items-start rounded-xl'>
                <div className="bg-[#0898A0] w-fit rounded-xl p-14 flex flex-col justify-start items-start relative">
                    <p className="font-Onest text-white text-[40px] leading-[51px] w-full md:w-[400px] text-left mb-10">
                        Open your PenSphere account
                        now. It’s fast and easy.
                    </p>
                    <p className='w-full max-w-[400px] text-[16px] font-normal p-0 text-left text-white'>
                        Experience a world of convenience, security, and ease with PenSphere
                        as your trusted pension remittance partner.
                    </p>
                    <a className="flex flex-row justify-start items-center" href="https://pensphere.ng/register">
                        <button className="hover:opacity-80 bg-[#3AADB4] cursor-pointer text-white text-sm font-normal !hover:text-az-[#3AADB4] w-full lg:w-fit h-10 rounded font-Onest px-6 lg:flex hidden flex-row justify-between items-center stroke-white hover:stroke-az-black-900 text-nowrap whitespace-nowrap" onClick={() => navigate.push('/register')}>
                ...
                <img src={illustrations.personalCtaImg} alt="" className=' right-5 object-contain h-full w-full sm:w-auto' />
            </div>
        </div>
    );
};
